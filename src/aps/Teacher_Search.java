...
String b=t2.getText();
    ...
    Class.forName("com.mysql.jdbc.Driver");
      ...
      String q="select * from teacher where Employee_ID='"+a+"'";
...
ti.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teacher_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
